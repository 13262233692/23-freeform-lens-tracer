...
static constexpr auto qt_meta_stringdata_ZN8GLCanvasE = QtMocHelpers::stringData(
    "GLCanvas",
    "statusMessage",
    "",
    "msg"
...
Q_CONSTINIT static const uint qt_meta_data_ZN8GLCanvasE[] = {
...
Q_CONSTINIT const QMetaObject GLCanvas::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8GLCanvasE.offsetsAndSizes,
    qt_meta_data_ZN8GLCanvasE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8GLCanvasE_t,
        // Q_OBJECT / Q_GADGET
...
void GLCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (GLCanvas::*)(const QString & );
            if (_q_method_type _q_method = &GLCanvas::statusMessage; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *GLCanvas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8GLCanvasE.stringdata0))
